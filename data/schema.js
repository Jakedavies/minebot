...
var minerType = new GraphQLObjectType({
  name: 'Miner',
  description: 'A shiny widget',
  fields: () => ({
    id: globalIdField('Miner'),
    name: {
      type: GraphQLString,
...
var {connectionType: minerConnection} =
  connectionDefinitions({name: 'Miner', nodeType: minerType});
